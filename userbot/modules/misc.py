...
async def repo_is_heree(wannaseee):
    ...
    await wannaseee.edit(
        "[Click here](https://github.com/darkness2580/ProjectFizilion) to open my fork of Fizilion's GitHub Repo."
    )
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "[Click here](https://heroku.com/deploy?template=https://github.com/darkness2580/ProjectFizilion/tree/main) to deploy Fizilion Userbot on Heroku."
    )
